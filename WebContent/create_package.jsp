...
%>
<%
	List<Integer> current_food_item_list = new ArrayList<Integer>();
%>
<%
	int countOfFoodItem = 0;
%>
<%String[] xlist = new String[20]; %>
...
<script>
	$(document).ready(function()
	{
		...
		$("#logoutButton2").attr('disabled', 'disable');
		$('input[type="checkbox"]').click(function(){
			...
			if($(this).prop("checked") == true)
			{
				...
				{ 
					$("#logoutButton2").prop('disabled', false);
				}
				if (numberOfChecked > 10) {
					alert("You Can Select Only 10 Items");
			...
			else if($(this).prop("checked") == false)
			{
				...
				if(numberOfChecked < 5)
				{
					$("#logoutButton2").prop('disabled', true);
				}
<%-- 				<%for(int y: current_food_item_list){%> --%>
<%-- 					<%if(temp == y){%> --%>
<%-- 						<%current_food_item_list.remove(y);%> --%>
<%-- 						<%System.out.println("\nREmoved ID: " + temp);%> --%>
<%-- 					<%}%> --%>
<%-- 				<%}%> --%>
			}
...
<body itemscope>
									...
									<div class="row">
											...
											<div class="profile-sidebar brd-rd5 wow fadeIn"
												...
												<div class="profile-sidebar-inner brd-rd5">
													<ul class="nav nav-tabs">
														...
														%>
														<li><a id="curr_package" href="#current_package"
															data-toggle="tab"><i class="fa fa-dashboard"></i>CURRENT
																PACKAGE</a></li>
													</ul>

													<a href="AddToPackage?pid2=<%=pid2%>" id="logoutButton2"
														onclick="return checkCount()">CREATE PACKAGE</a>
												</div>
										...
										<div class="col-md-8 col-sm-12 col-lg-8">
											<div class="tab-content">
														...
														<div class="restaurants-list">
															<div
																...
																<div class="view-menu-liks">
																	...
																	<!-- 																	Package</button> -->
																	<br> <input type="checkbox" class="checkFood"
																		id="checkFood" name="selectProduct"
																		value="<%=obj.getFood_item_id()%>">Add To
																	Package</input>
												...
												<!--  Curr Package -->
												<div class="tab-pane fade" id="current_package">

													<div class="dashboard-wrapper brd-rd5">
														<div class="restaurants-list">
															<%
																for (Food_items listFood : list_of_product) {
															%>
															<%
																Food_items obj2 = new Food_items();
															%>
															<%
																for (Integer foodIndex : current_food_item_list) {
															%>
															<%
																if (foodIndex == listFood.getFood_item_id()) {
															%>
															<%
																obj2 = list_of_product.get(foodIndex);
															%>
															...
															<div
																...
																<div class="featured-restaurant-thumb">
																	<a href="#" title="" itemprop="url"><img
																		src="data:image/png;base64,<%=obj2.getFoodItemImageString()%>"
																		alt="restaurant-logo1-1.png" itemprop="image"></a>
																</div>
																<div class="featured-restaurant-info">
																	<span class="red-clr"><%=obj2.getFood_item_id()%></span>
																	<h4 itemprop="headline">
																		<a href="#" title="" itemprop="url"><%=obj2.getFood_item_name()%></a>
																	</h4>
																	<ul class="post-meta">
																		<li><i class="fa fa-check-circle-o"></i> <%=obj2.getFood_item_price()%></li>
																...
																<div class="view-menu-liks">
																	...
																	<br> <input type="checkbox" class="checkFood"
																		id="checkFood" name="selectProduct"
																		value="<%=obj2.getFood_item_id()%>">Add To
																	Package</input>
	...
	<script>
		...
		function checkLog()
		{
			document.getElementById('checkFood').onclick = function() {
				  countOfCheck = document.querySelectorAll('input[type="checkbox"]:checked');
				  alert(countOfCheck.length);
				}
		}
		document.getElementById('checkFood').onclick = function() {
			  countOfCheck = document.querySelectorAll('input[type="checkbox"]:checked');
		...
		function checkCount()
		{
			...
			if(countOfCheck < 5){
				alert("Please Select Minimum 5 Items!");
				return false;
			}else if(countOfCheck > 10){
				alert("Items Can't Be Greater Than 10!");
				return false;
			}else{
				return true;
			}
