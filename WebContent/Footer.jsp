                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-lg-3">
                                        <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                                            <div class="logo"><h1 itemprop="headline"><a href="#" title="Home" itemprop="url"><img src="assets/images/resource/GuptaLog.png" alt="logo.png" itemprop="image"></a></h1></div>
                                            <p itemprop="description">Gupta Caterers And Decoraters Are Best Choice For Your Any Special Occasions Or Functions.</p>
                                            <div class="social2">
                                 ...
                                 <!-- <div class="col-md-3 col-sm-6 col-lg-3">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-lg-3">
                                        <div class="widget get_in_touch wow fadeIn" data-wow-delay="0.4s">
                                            ...
                                            <ul>
                                               <li><i class="fa fa-map-marker"></i>Shop No: 4, Opp. Parshwanath Bus-Stop, B/H Krishnanagar, 
New-Naroda, Ahmedabad, 382345.</li>
                                               <li><i class="fa fa-phone"></i> (+91) 9376111403</li>
                                               <li><i class="fa fa-envelope"></i> <a href="#" title="" itemprop="url">guptacatering11@gmail.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
